...
import { CMS_LIST_CACHE_CONTROL, fetchActiveClothesPresets, thumbnailVariant } from "../../lib/payload.js";

/**
 * GET /v1/clothes-presets — CMS-gestuurde kleding-presets (E33+).
 *
...
export default async function handler(_req: VercelRequest, res: VercelResponse) {
  ...
  try {
    const presets = await fetchActiveClothesPresets();
    ...
    console.error("/v1/clothes-presets error:", msg);
