...
| [E14 Monetization 2.0](E14-monetization.md) | FEAT+INFRA | **done** (14.1–14.7, incl. Stripe-webhook-shapefix); **14.9 done** (Pro-lijst via CMS-collectie `pro-access` — uitrol wacht op sql/018 + admin/backend-deploy); 14.8 backlog (credits-transparantie); **14.10 done** (drop-import boven de Starter-cap: pre-flight, deel-import + toast, hervatten na upgrade — 2026-09-02, gemerged naar v2-main 2026-09-02); **14.11 done** (INFRA: `/v1/account` spiegelt de device-teller — prod-deploy avatars-api nog te doen); **14.12 done** (INFRA: two-bucket `current_credits`, top-ups overleven de renewal — optie (a) bevestigd 2026-09-04; sql/022 in de Supabase SQL-editor draaien is nog Thierry's stap) |
| [E15 Settings volledig](E15-settings.md) | FEAT | **done** (15.1–15.7) · **15.8 done** (Billing & Invoices-pagina, 2026-09-02 — gemerged naar v2-main 2026-09-02) |
...
| [E31 Toolbar-unificatie](E31-toolbar-unification.md) | FEAT+DS | **done** (31.1–31.8); follow-up "Restore body"-strings gedaan in E49.2 (gemerged naar v2-main 2026-09-02) |
...
| [E55 Effects 2.0](E55-effects-2.0.md) | INFRA+FEAT+DS+AI | **55.1–55.9 done** (incl. uitrol 9 stijlen + live-smoke stijlmatch). **55.10 deferred** — niet release-blokkerend (stijlmatch shipped; remat-ORMBG-prefer post-release). Rest: 3 thumbnails later; **55.12 backlog** (effect-versiehistorie: history-icoon naast Refresh, besluit Thierry 2026-09-03); **55.13 done** (2026-09-04: sticker-rand + hoofd-alleen deterministisch op de client via `DieCutRenderer`; prompt-tweak wacht op avatars-api-deploy) |
| [E56 Fill in body: minimale reparatie](E56-fill-body-precision.md) | FEAT+INFRA | **56.1 done** (2026-09-01) · **56.2 done** (2026-09-03: snede-detectie op de alpha-bbox i.p.v. de canvasrand — gutter verbergt geen snede meer) · **56.3 done** (2026-09-03: maskerstroken begrensd op het onderwerp + positieve prompt met tekst-ban — tegen ondertitelbalk-wartaal) — 56.2+56.3 live op prod 2026-09-03 |
| [E57 "Edit"-submenu in het tegelmenu](E57-gallery-edit-menu.md) | DS+FEAT | **done** (57.1–57.6, 2026-09-03): `DSMenuSubmenu` + Edit ▸ Boost / Fill in body / Apply effect als set-acties (low-res-gate per batch, Stop-knop) in tegelmenu én board-menu via `PortraitEditSubmenu` |
| [E58 Parallelle cloud-edits over portretten](E58-cloud-jobs-parallel.md) | FEAT+DS+INFRA | backlog (58.1 job-registry: parallel over portretten, serieel per portret, cap 3 + FIFO; 58.2 multi-job WorkingToast; 58.3 aparte stylize-rate-bucket) — audit 2026-09-03, richting wacht op bevestiging Thierry |
