...
| [E14 Monetization 2.0](E14-monetization.md) | FEAT+INFRA | **done** (14.1–14.7, incl. Stripe-webhook-shapefix); **14.9 done** (Pro-lijst via CMS-collectie `pro-access` — uitrol wacht op sql/018 + admin/backend-deploy); 14.8 backlog (credits-transparantie); **14.10 done** (drop-import boven de Starter-cap: pre-flight, deel-import + toast, hervatten na upgrade — 2026-09-02, merge pending); **14.11 done** (INFRA: `/v1/account` spiegelt de device-teller — prod-deploy avatars-api nog te doen) |
| [E15 Settings volledig](E15-settings.md) | FEAT | **done** (15.1–15.7) · **15.8 done** (Billing & Invoices-pagina, 2026-09-02 — merge pending) |
