...
| [E56 Fill in body: minimale reparatie](E56-fill-body-precision.md) | FEAT+INFRA | **56.1 done** (2026-09-01) |
| [E57 "Edit"-submenu in het tegelmenu](E57-gallery-edit-menu.md) | DS+FEAT | **57.1 done** (`DSMenuSubmenu`: genest child-window-submenu, hover-intent + keyboard, 2026-09-03); 57.2–57.5 ready; 57.6 board-menu backlog — Boost bij enkel-select in mappen + Edit ▸ Boost / Fill in body / Apply effect |
