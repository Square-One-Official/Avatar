...
| [E41 Boost Resolution](E41-upscale-quality.md) | INFRA+FEAT | **done** (41.1–41.2); **41.4 in_progress** — code klaar (edge-bleed, reapplyAlpha-alphadrop-fix, armen topaz/google), lokaal groen; open: preview-bakeoff → default-flip. 41.3 opgegaan in 41.4 |
