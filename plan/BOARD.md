...
| [E53 UX-polish](E53-ux-polish.md) | FEAT+DS | 53.1 + 53.4 + 53.6 ready; **53.3 done** (gemerged, live AX-geverifieerd); **53.2** UX1 gemerged, UX2 kan nu (BannerStudioView vrij, E53.7 geland); 53.5 backlog; **53.7 done** (persistente presentatie afgerond 2026-07-31 — laatste drie dropdowns naar de store); 53.8 backlog (Apple-Intelligence-sheet op stabiele host) |
