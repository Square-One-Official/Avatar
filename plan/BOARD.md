...
| [E55 Effects 2.0](E55-effects-2.0.md) | INFRA+FEAT+DS+AI | **55.1–55.6 + 55.9 done** (aspect-contract, gpt-image-2-default server-governed, stacking-fix, Create→header, importer+hardening, instant thumbnails, generatie-feedback+cancel; incl. 2×edge-sweep); **55.7 in_progress** (harness done, live runs gated op token; kwaliteitsbesluit = high, Thierry 2026-08-03); **55.8 ready** (prod-uitrol-checklist, gated op Thierry) |
