...
| [E55 Effects 2.0](E55-effects-2.0.md) | INFRA+FEAT+DS+AI | **55.1–55.6 + 55.9 done** (aspect-contract, gpt-image-2-default server-governed, stacking-fix, Create→header, importer+hardening, instant thumbnails, generatie-feedback+cancel; incl. 2×edge-sweep); **55.7 done** (bakeoff 2026-08-03: identiteit ✅ 34/34, refs aan; besluiten: medium-default, 4cr, flowers prompt-only); **55.8 done** (uitrol 2026-08-03: 9 stijlen live, oude 4 uit; bijvangst sql/019 — Messages/banner_presets ontbraken op prod) — **E55 compleet** (rest: app-smoke + 3 thumbnails later) |
