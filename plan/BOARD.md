...
| [E55 Effects 2.0](E55-effects-2.0.md) | INFRA+FEAT+DS+AI | **55.1–55.6 done** (aspect-contract, OpenAI-default server-governed, stacking-fix, Create→header, importer+hardening, instant thumbnails); **55.7 in_progress** (harness done, live runs gated op token); **55.8 ready** (prod-uitrol-checklist, gated op Thierry) |
